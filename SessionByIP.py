...
MY_IP = input("Please enter IP address: ")
url = "https://" + ISE_IP + "/admin/API/mnt/Session/EndPointIPAddress/" + MY_IP

payload = {}
headers = {
  'Accept': 'application/xml',
  'Authorization': 'Basic YWRtaW46MXEydzNlNHJU'
}
...
print(f"Switch Port ID: {nas_port_id}")
print(f"Endpoint MAC: {calling_station_id}")
print(f"Switch Name: {network_device_name}")
print(f"Username/Hostname: {user_name}")
